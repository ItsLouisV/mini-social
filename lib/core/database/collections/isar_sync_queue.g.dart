...
extension IsarSyncQueueByIndex on IsarCollection<IsarSyncQueue> {
  ...
  List<Id> putAllByIdSync(List<IsarSyncQueue> objects,
      {bool saveLinks = true}) {
...
extension IsarSyncQueueQuerySortBy
  ...
  QueryBuilder<IsarSyncQueue, IsarSyncQueue, QAfterSortBy> sortByActionType() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarSyncQueue, IsarSyncQueue, QAfterSortBy> sortByPayloadJson() {
    return QueryBuilder.apply(this, (query) {
...
extension IsarSyncQueueQuerySortThenBy
  ...
  QueryBuilder<IsarSyncQueue, IsarSyncQueue, QAfterSortBy> thenByActionType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'actionType', Sort.asc);
    });
  }
  ...
  QueryBuilder<IsarSyncQueue, IsarSyncQueue, QAfterSortBy> thenByPayloadJson() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'payloadJson', Sort.asc);
    });
  }
...
extension IsarSyncQueueQueryWhereDistinct
  ...
  QueryBuilder<IsarSyncQueue, IsarSyncQueue, QDistinct> distinctByActionType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarSyncQueue, IsarSyncQueue, QDistinct> distinctByPayloadJson(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension IsarSyncQueueQueryProperty
  ...
  QueryBuilder<IsarSyncQueue, String, QQueryOperations> actionTypeProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<IsarSyncQueue, String, QQueryOperations> payloadJsonProperty() {
    return QueryBuilder.apply(this, (query) {
