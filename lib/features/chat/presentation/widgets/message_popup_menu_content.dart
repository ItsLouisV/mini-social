...
class MessagePopupMenuContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<_GridActionItem> actionItems = isRecalled
        ? [
            _GridActionItem(
        ...
        : [
            ...
            if (onSaveMedia != null)
              _GridActionItem(
                ...
                label: saveMediaLabel ?? 'Lưu nội dung',
                onTap: onSaveMedia!,
                iconColor: Colors.blue,
              ),
            if ((isPinned ? onUnpin : onPin) != null)
              _GridActionItem(
    ...
    return Material(
      ...
      child: Column(
        ...
        children: [
          // Recalled messages intentionally expose only permanent deletion.
          if (!isRecalled)
            Container(
          ...
          if (!isRecalled) const SizedBox(height: 18),
